        ...
        <form className="border border-slate-200 rounded-lg w-[50%] h-[100%]">
          ...
          <div className="telephone input flex flex-col mt-8">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <input
                type="tel"
                className=" border bg-slate-100 text-gray-700 rounded-lg mt-3 mx-2 w-[90%] h-10"
              />
            </div>
          </div>
          ...
          <div className="password input flex flex-col mt-5">
            ...
            <input
              type="password"
              className="bg-slate-100 text-gray-700 rounded-lg mt-3 mx-2 w-[90%]"
            />
          </div>
          <div className="password input flex flex-col mt-5">
          ...
          <div className="flex justify-center">
            <button className="w-[90%] border bg-orange-600 rounded mx-2 mt-4 h-10">
              تسجيل الدخول
            </button>
          </div>
