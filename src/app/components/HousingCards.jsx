      ...
      >
        <div
          className={`bg-cover bg-no-repeat ${
            isTwoPerRow ? "h-[180px]" : "h-[180px]"
          }`}
          style={{ backgroundImage: `url(${property.cover})` }}
        ></div>
        <div className={`p-4 ${isTwoPerRow ? "!bg-cardbg" : "!bg-dcardbg"} flex flex-row`} dir="rtl">
          <div className="flex flex-col items-start">
            <h2 className={`text-xs font-semibold ${isTwoPerRow ? "text-base" : "!text-dcardtext"}`}>
              {property.type}
            </h2>
