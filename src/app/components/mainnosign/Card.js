...
const Card = ({ property }) => {
  return (
    <Link href={`Reserve/${property.id}`}> 
      <div className="w-[358px] md:w-[500px] h-[137px] border-[0.5px] bg-[#303030] rounded-[12px] overflow-hidden flex row">
        <div className="flex row p-[20px]">
          ...
          <div className="flex flex-col items-end ">
            <div className="mr-0 md:mr-24 w-[92px] md:w-[108px] h-[97px] flex flex-col " dir="ltr">
              <div className="mb-8">
            ...
            <Link  href={`/Reserve/${property.id}`} key={property.id} 
             className="w-[108px] h-[33px] flex items-center justify-center px-4 py-1 mr-0 md:mr-2 bg-stayro text-gray-100 rounded-[8px] shadow-md hover:bg-opacity-90 transition duration-300"
            >
