...
import { authStore } from "../../../stores/ProviderStore";
...
const Login = observer(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!authStore.errorMessage) {
      router.push("/Provider/ProviderVerifyLogin");
    }
  };
    ...
    <>
      <div className="main flex flex-col md:flex-row  justify-center items-center lg:items-start ">
        <div className="login  lg:w-[63%] h-[748px] flex-col md:items-center mt-20 md:w-full ">
          ...
          <div className="flex justify-center md:mt-20 lg:mt-4">
            {authStore.errorMessage && (
              <p className=" border-2 border-red-600 bg-[#FFFFFF0D] text-red-600 text-center mt-2 p-2 rounded w-[350px] mx-44 my-10">
                {authStore.errorMessage}
              </p>
            )}
          </div>
          ...
          <form
            ...
            className="flex flex-col  border border-[#303030] rounded-[20px] lg:w-[540px] lg:h-[500px] mt-2 mb-4 lg:mx-20 md:mx-44 md:mx-10 md:w-[517px] sm:w-[394px]"
          >
            ...
            <div className="text-right mt-5 mx-2 text-orange-500">
              <Link href="/Provider/ProviderEnterPhone">
                هل نسيت كلمة المرور؟
              </Link>
            </div>
